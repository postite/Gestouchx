...
import org.gestouch.utils.ObjectHash;
 ...
 class GesturesManager implements IGesturesManager {
	...
	//public function addGesture(gesture : Dynamic) : Void{}
	// public function removeGesture(gesture : Dynamic) : Void{}
	// public function scheduleGestureStateReset(gesture : Dynamic) : Void{}
	// public function onGestureRecognized(gesture : Dynamic) : Void{}
